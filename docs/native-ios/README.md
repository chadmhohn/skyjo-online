...
4. Prevent rule drift with versioned, deterministic JSON fixtures generated by the TypeScript implementation and consumed by both TypeScript and Swift tests.
...
The implementation workspace starts at [`ios/README.md`](../../ios/README.md); the bootstrap issue adds the Xcode project there. The checked-in project, schemes, entitlements templates, test plans, and Swift packages become part of this repository; they must not live only in a developer's local Xcode state.

GitHub execution starts at [program issue #179](https://github.com/chadmhohn/skyjo-online/issues/179) in the [Skyjo Native iOS v0.1.0 milestone](https://github.com/chadmhohn/skyjo-online/milestone/3). After this handoff issue closes, the first implementation issue is [#181](https://github.com/chadmhohn/skyjo-online/issues/181).
