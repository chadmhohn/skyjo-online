...
const result = await runDeployedSmoke({
  ...
  accessPassword: process.env.SKYJO_SMOKE_ACCESS_PASSWORD,
  accountEmail: process.env.SKYJO_SMOKE_ACCOUNT_EMAIL,
  accountPassword: process.env.SKYJO_SMOKE_ACCOUNT_PASSWORD,
