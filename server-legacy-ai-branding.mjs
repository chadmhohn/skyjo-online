...
const legacyAiNameMap = new Map(
  legacySinglePlayerAiNameHashes.map((hash, index) => [hash, currentSinglePlayerAiNames[index]])
);

export function legacyAiNameHash(name) {
...
export function replacementForLegacyAiName(name) {
