...
- Preserved application/runtime bytes, production dependencies, schema 2, protocol 2, offline restoration, cache, and credentialless assertions while creating the immutable `v0.3.2` successor.
