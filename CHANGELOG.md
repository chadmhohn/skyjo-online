...
- Upgraded React Router to 7.18.2, centralized and hardened account return-path navigation, and removed the expiring moderate-advisory exception. Refreshed the release audit toolchain to Lighthouse 13.4.1 and patched transitive dependencies, leaving zero moderate, high, or critical audit findings.
